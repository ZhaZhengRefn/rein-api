...
var Rein = (function () {
    ...
    ***************************************************************************** */
    ...
    //# sourceMappingURL=adaptor-fetch.js.map
    ...
    var AdaptorFetch = /** @class */ (function (_super) {
        ...
        AdaptorFetch.prototype.apply = function (requestConfig) {
            ...
            return window
                ...
                var fetchError = createError('Request failed with status code ' + response.status, response, requestConfig);
                return Promise.reject(fetchError);
            });
        };
        return AdaptorFetch;
    }(BaseAdaptor));
    //# sourceMappingURL=AdaptorFetch.js.map
    ...
    var HEADERS_TO_DELETE = [
        'common'
    ].concat(Object.keys(MethodNames).map(function (k) { return k.toLowerCase(); }));
    var DispatchRequest = /** @class */ (function () {
        function DispatchRequest(config, adaptor) {
            ...
            this.config.headers = lodash_merge({}, config.headers || {}, DEFAULTS.dispatchConfig.headers);
            this.debug = this.config.debug || false;
            this.adaptor = adaptor;
            this.dispatch = this.dispatch.bind(this);
        }
        DispatchRequest.prototype.dispatch = function (options) {
            options = lodash_merge({}, DEFAULTS.dispatchOption, options);
            this.debug &&
            ...
            // 拼接 url
            var absoluteUrl = buildUrl(baseUrl, prefix || defaultPrefix, url, restful, resource);
            // 拼接 query 参数
            absoluteUrl = addQuery(absoluteUrl, params);
            // 转换 data
            transformData(data, headers, transformRequest);
            // 序列化 data
            ...
            return this.adaptor
                ...
                .then(function (res) {
                // 转换response
                transformData(res.data, res.headers, transformResponse);
                var data = lodash_merge(Object.create(null), res.data);
                return Promise.resolve(data);
            }, function (e) {
                // 转换response
                transformData(e.response.data, e.response.headers, transformResponse);
